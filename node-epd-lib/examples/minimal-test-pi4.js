...
const EPDConfigFSPi4 = require("../src/epd-config-fs-pi4");

async function minimalHardwareTestPi4() {
  console.log("Minimal E-Paper Hardware Test (Pi 4 File System GPIO)");
  console.log("=====================================================");

  const epdConfig = new EPDConfigFSPi4();
...
// Run the test
minimalHardwareTestPi4().catch(console.error);
