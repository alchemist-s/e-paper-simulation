...
const EPD7in5bV2Pi4 = require("../src/epd7in5b-v2-pi4");

async function displayBorderedBox() {
  console.log("E-Paper Bordered Box Test (Pi 4)");
  console.log("=================================");

  const epd = new EPD7in5bV2Pi4();
  ...
  try {
    ...
    await epd.epdConfig.delay(10000);
    ...
    console.log(
      'You should have seen a bordered box with "E-PAPER" text on your e-paper display.'
    );
  } catch (error) {
