...
const EPDConfigFSCustom = require("../src/epd-config-fs-custom");

async function minimalHardwareTestCustom() {
  console.log("Minimal E-Paper Hardware Test (Custom GPIO)");
  console.log("==========================================");

  const epdConfig = new EPDConfigFSCustom();
...
// Run the test
minimalHardwareTestCustom().catch(console.error);
